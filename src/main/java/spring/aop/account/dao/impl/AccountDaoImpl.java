package spring.aop.account.dao.impl;
...
import spring.aop.account.util.ConnectionUtil;
...
public class AccountDaoImpl implements AccountDao {
    ...
    public Account findAccountsByName(String name) {
        try {
            List<Account> accounts = runner.query(connectionUtil.getThreadConnection(), "select * from account where name = ? ", new BeanListHandler<>(Account.class), name);
